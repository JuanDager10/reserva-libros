...
--
ALTER TABLE `Libros`
  MODIFY `idLibros` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
...
--
ALTER TABLE `Reserva`
  ADD CONSTRAINT `Reserva_ibfk_1` FOREIGN KEY (`Usuarios_idUsuarios`) REFERENCES `Usuarios` (`idUsuarios`) ON DELETE NO ACTION ON UPDATE CASCADE,
  ADD CONSTRAINT `Reserva_ibfk_2` FOREIGN KEY (`Libros_idLibros`) REFERENCES `Libros` (`idLibros`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
